             ...
             Form(
               key: GKeys.updateProfileFormKey,
                  ...
                  child: Column(
                        ...
                        children: [
                            Consumer<AppAuthProvider>(builder: (context, authProvider, child) {
                             return Center(
                              child: Stack(
                                children: [
                                 ...
                                 authProvider.img != null
                                      ...
                                      ? CircleAvatar(
                                          radius: 70,
                                          backgroundImage: NetworkImage(authProvider.img!,
                   ...
                   TextButtonWidget(
                                  press: () async {
                                    Provider.of<AppAuthProvider>(context, listen: false).updateUserName(context);
                                    ///Navigator.pop(context);
